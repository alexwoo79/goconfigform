...
| 角色 | 权限 |
|------|------|
| **管理员** | 访问配置管理页面、查看所有用户数据、切换表单配置、导出 CSV、用户管理 |
| **普通用户** | 填写表单、查看自己的数据、修改自己的密码 |
...
| 路由 | 功能 |
|------|------|
| `GET /user-manager` | 用户管理页面 |
| `POST /user-manager/change-password` | 修改当前用户密码 |
| `POST /user-manager/add` | 添加新用户 |
| `POST /user-manager/edit` | 编辑用户 |
| `POST /user-manager/delete` | 删除用户 |
